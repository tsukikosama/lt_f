<template>
  <div class="mycontent">
    ...
    <div v-html="markdownSource.content" class="content">

    </div>
    <div class="t">
      <div><el-span>{{ markdownSource.ctime }}</el-span></div>
      <div><el-tag>标签一</el-tag><el-tag>标签一</el-tag><el-tag>标签一</el-tag><el-tag>标签一</el-tag></div>
    </div>
    <div class="review">
      <h1>评论区</h1>
      <div>
        ...
        <div >
           <div class="chat-right">
            ...
            <div class="chat-reply">
              <el-span>{{reply.time}}</el-span><el-span>
            <i  @click="like(index2)" :class="reply.flag?'el-icon-star-on':'el-icon-star-off'">{{reply.likes}} </i>
            <!-- <i v-else  @click="like()" class="el-icon-star-on"></i> -->
            </el-span>
...
export default {
    ...
    methods:{
      init(){
        request.get('/post/'+this.$route.query.pid).then((res) =>{
      ...
      like(index1,index2){
        ...
        sumbit(){
          ...
          this.$set(this.replycontent,"avatar",u.avatar)
    ...
    mounted(){
      ...
      if(user != null){
        ...
        request.get('/review/likes?pid='+pid+"&uid="+user.uid).then((res) =>{
          //查找全部的点赞评论
          console.log(res)
